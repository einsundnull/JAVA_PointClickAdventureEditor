...
public class UniversalPointEditorDialog extends JDialog {
	 ...
	 */
	public UniversalPointEditorDialog(EditorMain parent, KeyArea keyArea) {
	 ...
	 */
	public UniversalPointEditorDialog(EditorMain parent, Item item) {
	 ...
	 * Generic constructor
	 */
	private UniversalPointEditorDialog(EditorMain parent, String objectName, List<Point> points, Runnable onSave) {
