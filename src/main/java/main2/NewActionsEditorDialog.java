...
/**
 * New Actions Editor with checkbox-based UI
...
public class NewActionsEditorDialog extends JDialog {
    ...
    private void initUI() {
        ...
        conditionsTable.getColumnModel().getColumn(2).setPreferredWidth(100); // Current Value
        ...
        conditionsTable.getColumnModel().getColumn(2).setCellRenderer(new CurrentValueRenderer());
    ...
    private void loadExistingActions() {
        ...
        // Load existing actions for this keyArea and actionName
    ...
    private void saveActions() {
        ...
        for (int i = 0; i < usedRows.size(); i++) {
            ...
            conditionsStr.append(row.conditionName).append("=").append(row.getCurrentValue());
    ...
    class ConditionsTableModel extends AbstractTableModel {
        ...
        private String[] columnNames = {"Conditions", "use", "Current Value", "Result Value", "Result Process"};
        ...
        public Object getValueAt(int rowIndex, int columnIndex) {
            ...
            switch (columnIndex) {
                ...
                case 2: return row.getCurrentValue();
        ...
        public boolean isCellEditable(int rowIndex, int columnIndex) {
            // Columns 1 (use), 3 (result value), and 4 (process) are editable
    ...
    class CurrentValueRenderer extends JLabel implements TableCellRenderer {
        @Override
        public Component getTableCellRendererComponent(JTable table, Object value,
                boolean isSelected, boolean hasFocus, int row, int column) {
            setText(value != null ? value.toString() : "false");
            setHorizontalAlignment(SwingConstants.CENTER);
            setOpaque(true);
