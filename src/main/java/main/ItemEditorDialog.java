...
public class ItemEditorDialog extends JDialog {
	...
	private void initUI() {
		...
		leftCollapseBtn.setFont(new Font("Arial", Font.BOLD, 10));
		leftCollapseBtn.setToolTipText("Collapse/Expand Items List");
		leftCollapseBtn.setPreferredSize(new Dimension(25, 0));
		...
		mouseFollowingPanel.setBorder(BorderFactory.createTitledBorder("Mouse Following"));
		...
		// Bottom buttons - nach Schema
		JPanel bottomPanel = new JPanel(new FlowLayout(FlowLayout.RIGHT));
		bottomPanel.setBorder(BorderFactory.createEmptyBorder(0, 10, 10, 10));

		JButton openActionEditorBtn = new JButton("⚡ Open Action Editor");
	...
	private JPanel createImagesSection() {
		...
		// Title panel with collapse button
		JPanel titlePanel = new JPanel(new BorderLayout());
		JLabel titleLabel = new JLabel("Images");
		titleLabel.setFont(new Font("Arial", Font.BOLD, 12));
		titlePanel.add(titleLabel, BorderLayout.WEST);

		JButton collapseBtn = new JButton("▼ Collapse");
		collapseBtn.setFont(new Font("Arial", Font.PLAIN, 10));
		titlePanel.add(collapseBtn, BorderLayout.EAST);
		titlePanel.setBorder(BorderFactory.createEmptyBorder(5, 10, 5, 10));

		section.add(titlePanel, BorderLayout.NORTH);
		section.setBorder(BorderFactory.createTitledBorder(""));
		section.setMinimumSize(new Dimension(0, 50)); // Minimum size when collapsed
		...
		JButton addImageBtn = new JButton("Add Image Field");
		...
		// Collapse functionality with JSplitPane support
		collapseBtn.addActionListener(e -> {
			if (contentPanel.isVisible()) {
				// Collapse
				contentPanel.setVisible(false);
				collapseBtn.setText("▶ Expand");
				section.setPreferredSize(new Dimension(section.getWidth(), 50));
				splitPane1.setDividerLocation(50); // Collapse to minimum
			} else {
				// Expand
				contentPanel.setVisible(true);
				collapseBtn.setText("▼ Collapse");
				section.setPreferredSize(null);
				splitPane1.setDividerLocation(0.33); // Restore to 1/3
			}
	...
	private JPanel createCustomClickAreaSection() {
		...
		// Title panel with collapse button
		JPanel titlePanel = new JPanel(new BorderLayout());
		JLabel titleLabel = new JLabel("Custom Click Areas");
		titleLabel.setFont(new Font("Arial", Font.BOLD, 12));
		titlePanel.add(titleLabel, BorderLayout.WEST);
		...
		// Control button
		JPanel controlPanel = new JPanel(new FlowLayout(FlowLayout.LEFT, 10, 5));
		JButton addBtn = new JButton("Add Custom Click Area Field");
		...
		collapseBtn.addActionListener(e -> {
			if (contentPanel.isVisible()) {
				...
				collapseBtn.setText("▶ Expand");
				section.setPreferredSize(new Dimension(section.getWidth(), 50));
				splitPane2.setDividerLocation(50); // Collapse to minimum
			} else {
				// Expand
				contentPanel.setVisible(true);
				collapseBtn.setText("▼ Collapse");
				section.setPreferredSize(null);
				splitPane2.setDividerLocation(0.5); // Restore to 50%
			}
	...
	private JPanel createMovingRangeSection() {
		...
		// Title panel with collapse button
		JPanel titlePanel = new JPanel(new BorderLayout());
		JLabel titleLabel = new JLabel("Moving Ranges");
		titleLabel.setFont(new Font("Arial", Font.BOLD, 12));
		titlePanel.add(titleLabel, BorderLayout.WEST);
		...
		// Control button
		JPanel controlPanel = new JPanel(new FlowLayout(FlowLayout.LEFT, 10, 5));
		JButton addBtn = new JButton("Add Moving Range Field");
		...
		collapseBtn.addActionListener(e -> {
			if (contentPanel.isVisible()) {
				...
				collapseBtn.setText("▶ Expand");
				section.setPreferredSize(new Dimension(section.getWidth(), 50));
				// When MovingRange collapses, give all space to CustomClickArea
				splitPane2.setDividerLocation(1.0); // Move divider to bottom
			} else {
				// Expand
				contentPanel.setVisible(true);
				collapseBtn.setText("▼ Collapse");
