...
public class AdventureGame extends JFrame {
	...
	// Menu actions - REMOVED hardcoded array, now loaded from buttons.txt via ButtonsManager
	...
	private void initUI() {
		...
		inventoryPanel.setPreferredSize(new Dimension(1024, 120)); // Increased for full tile visibility
		...
		itemBtn.addActionListener(e -> {
			...
			if (selectedAction != null && (selectedAction.equals("Benutze") || selectedAction.equals("Gib"))) {
				...
				if (selectedInventoryItem != null && selectedInventoryItem.equals(item)) {
					...
					itemBtn.setBorder(BorderFactory.createLineBorder(Color.CYAN, 3));
